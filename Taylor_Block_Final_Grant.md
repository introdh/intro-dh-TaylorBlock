...
## **2) Abstract**
For this project, I will examine the covers of Vogue Magazine over the past ten years from all 17 countries that it is published in including: Australia, Brazil, China, France, Germany, Greece, India, Italy, Japan, Korea, Mexico, Portugal, Russia, Spain, Taiwan, United Kingdom, and United States. The data will consist of the text content featured on the cover. Using this data, a topic model will be created that highlights the key topics from each country over time. This will allow for analysis of the content per country, as well as over time. 
...
A similar project done at Yale University called Robots Reading Vogue used different digital humanities models to analyze the magazines. From a histogram addressing the colors on the magazine covers, to a topic model of the articles this project covers many humanities questions. One student involved in the project created a topic model of all articles ever published in Vogue from 1892-2013. This project produced a lot of data with topics ranging from dressmaking to politics. The topic model was successfully created, and showed many topics discussed in the magazine over time. While this was an effective and interesting topic model, I think that the data corpus used is almost too big to really be able to get into general themes. The website this project created showed an over whelming amount of data, that did not really provide any overarching standards. Rather, it provided information about everything ever spoken about throughout the magazines history. While this is certainly productive as it provides a massive amount of data, it is hard to draw conclusions from the research. 

With my project, there will be less topics thus there will hopefully be more concise themes that come out of the topic model. This will allow for further specific analysis instead of dealing with all this data. 

Similarly to the Yale project, once finished this project will be put online. This site will include images of the topic models, also similar to the other project. However, it will also included a detailed analysis done as well as all information about creating the project. The analysis will identify general trends, beauty standards and societal norms I presented as the humanities questions. This will allow for the information to be more comprehensive to the general public, as a key part of this study is making sure it is open and accessible to anyone who wants to see it as I struggled with getting more information on the Robots Reading Vogue project since it was all private. This will also allow for further research to be conducted quickly with no hoops to jump through for other researchers. Some future projects based off this one could include a psychology focused project on the effects of the topics generated on young women, and how the industry could be positively changed.


**History of the Project**

The idea for this project was conceived out of a need for more conclusive and public data regarding magazines effects on young women. After viewing a few projects including, Robots Reading Vogue, it was obvious that while there is interest in this topic, there is not much clear data. The algorithm used for most of Robots Reading Vogue had noticeable problems which tainted the data. The data that is accessible does not offer any answers to humanities questions, rather just an image of the data collected. Thus, this project will not only create data, but it will also apply the information in an analysis so it can be understood by the public. In order for this project to be meaningful, there needs to be more context than what has been provided in earlier projects. 

While the data collecting has not yet started for this project, there are many preliminary aspects that have begun. As stated earlier, this project will partner with the University of Richmond for the facilities needed to complete the data. We have created a group of students who are interested in collecting and analyzing data for this project. They will do this for internship college credit, thus they do not need to be paid. Additionally, while making this a class at the university the facilities will not need to be paid for by the project. Therefore, we can use the money granted to other aspects of the project like hiring experts to help analyze the data collected. 
...
Considering the popular and widely spoken about topic this project revolves around, I believe it will be relatively easy to distribute the project. Many college campuses would benefit from using the data in classes, as well as for students suffering from mental illness. In class, it could be used to teach students about data collecting or topic modeling. It could be used in psychology classes as the basis for a further study. In counseling centers, counselors could use the data to help identify societal issues with their patients. Another up and coming way of spreading research is through webinars. There is a large online community of bloggers who speak very openly about their mental illness, and how the media effects them. I think it would be interesting to have one of these bloggers use the data in a webinar. This would allow it to become far more accessible to a younger audience who are perhaps getting swept into the standards from magazines. 

The limitations of this project include a language barrier considering it is working with text from a number of different countries. At first, I would like to translate all of the writing into english, simply because the project is being done in the states. Depending on its success, it would be a long term goal to have a translator from each country address the translation as accurate or not. There are many phrases from other countries that do not exist in the english language, so it would be important to speak with a professional from each country to truly understand the meaning. 

Finally, as stated before, this project will be key in creating additional studies. It will be open to the public so that researchers from all over the world can use the data in their projects. I believe this is an incredibly important topic to gather more concrete and conclusion information about as to better understand how the advertising world effects consumers. 
