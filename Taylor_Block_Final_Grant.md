...
A similar project done at Yale University created a topic model of all articles ever published in Vogue from 1892-2013 called Robots Reading Vogue. This project produced a lot of data with topics ranging from dressmaking to politics.  While this was an effective and interesting topic model, I think that the data corpus used is almost too big to really be able to get into general themes. With this project, there will be less topics thus there will hopefully be more concise themes that come out of the topic model. This will allow for further specific analysis instead of dealing with all this data. 
